...
class ShellTechnique : public ITechnique {
public:
    ShellTechnique(const std::string& name, const std::string& mitreId, const std::string& cmd);
    ~ShellTechnique() = default;
...
private:
    std::string m_name, m_mitreId, m_cmd, m_result;
